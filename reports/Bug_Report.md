...
> Cột **GitHub Issue**: đã tạo đủ 16/16 issue (#1–#16), khớp đúng thứ tự bug trong bảng trên.
...
### B014 — Sửa 1 sản phẩm làm hiển thị sai toàn bộ danh sách cho đến khi tải lại trang
**Trước khi sửa:**
![B014-1](FR-15_bugs/B014-1.png)

**Form đang sửa (giá trị mới):**
![B014-2](FR-15_bugs/B014-2.png)

**Ngay sau khi lưu — toàn bộ sản phẩm bị đổi tên, dữ liệu sản phẩm sửa vẫn cũ:**
![B014-3](FR-15_bugs/B014-3.png)

**Sau khi F5 — trở lại đúng:**
![B014-4](FR-15_bugs/B014-4.png)

### B015 — Không giới hạn tên sản phẩm ở 255 ký tự
![B015](FR-15_bugs/B015.png)
...
### B016 — Không chặn submit khi để trống email/mật khẩu
![B016](FR-02-mobile_bugs/B016.png)
