...
| **B003** | [FR-02] UI không phân biệt "sai mật khẩu" và "tài khoản bị khóa" | **Pre:** Tài khoản đang bị khóa.<br>**Steps:** 1. Thử đăng nhập bằng mật khẩu ĐÚNG. 2. Đọc thông báo. 3. Đối chiếu response 403 trên DevTools.<br>**Expected:** Thông báo cho biết đang bị khóa (khác câu sai mật khẩu).<br>**Actual:** [điền — dự đoán: "Đăng nhập thất bại. Vui lòng kiểm tra lại." — cùng câu] | FR-02 | `FR-02_bugs/B003.png` | [link] | Open |
| **B004** | [FR-02] Ô mật khẩu hiển thị rõ ký tự (thiếu `type="password"`) | **Pre:** Ở trang /login.<br>**Steps:** 1. Gõ ký tự vào ô mật khẩu. 2. Quan sát.<br>**Expected:** Hiển thị dạng ẩn `•••` (FR-22).<br>**Actual:** [điền — dự đoán: hiện rõ chữ] | FR-02 | `FR-02_bugs/B004.png` | [link] | Open |
| **B005** | [FR-02] Ô email dùng `type="text"`, không validate định dạng | **Pre:** Ở /login.<br>**Steps:** 1. Nhập `abc` vào email, mật khẩu bất kỳ. 2. Bấm Sign In.<br>**Expected:** Bị chặn định dạng email (spec R5, `type="email"`).<br>**Actual:** [điền] | FR-02 | `FR-02_bugs/B005.png` | [link] | Open |
